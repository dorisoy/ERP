$(function () {
    ...
    $("#back,#btnClose").click(function () {
        location.href = '/OrderRefund/OrderRefund/Index';
    });
    //保存
    ...
    $('#orderRefundType').combobox({
        url: '/OrderRefund/OrderRefund/GetOrderRefundTypeJson?hasSelectedDefault=1',
        valueField: 'Value',
        textField: 'Name',
    ...
    $('#orderRefundDuty').combobox({
        url: '/OrderRefund/OrderRefund/GetOrderRefundDutyJson?hasSelectedDefault=1',
        valueField: 'Value',
        textField: 'Name',
...
function searchOutbound(billNo) {
    if (billNo.trim() != "") {
        ...
        $.ajax({
            url: "/OrderRefund/OrderRefund/SearchOutbound?billNo=" + billNo,
            type: "GET",
            async: false,
            cache: false,
            success: function (r) {
...
function searchPickItem(id) {
    $.ajax({
        url: "/OrderRefund/OrderRefund/SearchPickItem?id=" + id,
        type: "GET",
        async: false,
        cache: false,
        success: function (r) {
...
function btnSave(i) {
    $('#ff').form('submit', {
        url: "/OrderRefund/OrderRefund/Save",
