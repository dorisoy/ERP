...
function initTable(queryData) {
    ...
    $('#grid').datagrid({
        url: '/sys/User/search?ck='+$('#ck').val()+'&ram='+ Math.random(),
        ...
        onDblClickRow: function (rowIndex, rowData) {
            ...
            //    return false;
            //}
            //showLocalWindow("用户信息", "/sys/User/Edit?ck="+$('#ck').val()+"&id=" + rowData.ID, 700, 500, true, false, false);
        },
        columns: [[
 ...
 function setRole(id)
{
     ...
     showLocalWindow("角色信息", "/sys/User/userrole?UID=" + id, 700, 500, true, false, false);
}


 function setEdit(id) {
   
     showLocalWindow("用户信息", "/sys/User/Edit?ck=" + $('#ck').val() + "&id=" + id, 700, 500, true, false, false);
...
$("#add").click(function () {
    ...
    showLocalWindow("用户信息", "/sys/User/add?id=0", 700, 500, true, false, false);
