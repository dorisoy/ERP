...
namespace PaiXie.Erp.Areas.Sys {
	public class RoleController : BaseController {
		...
		public ActionResult Gettreebutton(string roleid = "") {
			...
			//List<Sysmenu>
			DataTable Sysmenulist = SysmenuService.GetDataTable(FormsAuth.GetModeType(), ZCookies.GetCookies("ck"));// GetSysmenulist();
		...
		public ActionResult Gettreegrid(string roleid = "") {
			...
			EasyUITree EUItree = new EasyUITree();
			DataTable dt = SysmenuService.GetDataTable(FormsAuth.GetModeType(), ZCookies.GetCookies("ck"));
			for (int i = 0; i < dt.Rows.Count; i++) {
