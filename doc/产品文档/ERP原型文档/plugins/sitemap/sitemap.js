...
(function() {
    ...
    function generateSitemap() {
        ...
        treeUl += "<a id='linksButton' title='获取连接' class='sitemapToolbarButton'></a>";
        ...
        treeUl += "<div><label><input type='radio' name='sitemapToggle' value='withoutmap'/>不带站点地图</label></div>";
        treeUl += "<div><label><input type='radio' name='sitemapToggle' value='withmap'/>带站点地图</label>";

        treeUl += "<div id='sitemapOptionsDiv'>";
        treeUl += "<div class='sitemapUrlOption'><label><input type='checkbox' id='minimizeBox' />最小化站点地图</label></div>";
        if($axure.document.configuration.showAnnotations == true) {
            treeUl += "<div class='sitemapUrlOption'><label><input type='checkbox' id='footnotesBox' />隐藏页面注释</label></div>";
        }

        treeUl += "<div class='sitemapUrlOption'><label><input type='checkbox' id='highlightBox' />高亮交互事件</label></div>";
